...
with mp_holistic.Holistic(min_detection_confidence=0.5,min_tracking_confidence=0.5) as holistic:
  while cap.isOpened():
    ...
    #display=round(probability[np.argmax(probability)],2)

    cv2.putText(flip,str(max(probability)), (900+100, 100), cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 0), cv2.LINE_AA)
    #cv2.putText(flip, str(display), (900 + 100,100+100), cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 0), cv2.LINE_AA)
